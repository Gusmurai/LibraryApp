...
/**
 * Вспомогательный класс для работы с подключением к базе данных PostgreSQL.
 * Выполняет загрузку параметров подключения и создание соединения
 * от имени пользователя, прошедшего авторизацию.
 */
